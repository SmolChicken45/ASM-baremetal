...
.\outils\ld.lld.exe -T linker.ld objects/main.o objects/pci.o objects/idt.o objects/input_handler.o objects/video.o objects/hw_limine.o objects/render.o objects/framebuffer.o -o iso_root/main.elf
